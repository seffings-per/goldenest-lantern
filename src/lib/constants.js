...
export const STATUS_META = {
  tried_liked: { label: 'Tried & Liked', icon: '💛', color: '#E8A030' },
  must_go: { label: 'Must Always Go', icon: '⭐', color: '#C9A84C' },
  loved: { label: 'Tried & Loved', icon: '🌟', color: '#2A9D8F' },
  meh: { label: 'Tried & Meh', icon: '🌀', color: '#8B7DA8' },
  never_again: { label: 'Never Again', icon: '🚫', color: '#9B2335' },
  want_to_try: { label: 'Want to Try', icon: '🔮', color: '#E8A87C' },
};
